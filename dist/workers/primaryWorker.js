...
workers_1.workers.primaryQueue.process(10, (job, done) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (action !== "Approval" &&
        ...
        if (error)
            console.log(`Error in TX ${transaction_hash} with ${contract_address} for ${token_id}`, error);
